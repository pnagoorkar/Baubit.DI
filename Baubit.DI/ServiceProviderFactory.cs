...
namespace Baubit.DI
{
    ...
    /// </remarks>
    public abstract class ServiceProviderFactory<TContainerBuilder> : IServiceProviderFactory<TContainerBuilder>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceProviderFactory{TContainerBuilder}"/> class.
        /// </summary>
        ...
        /// </remarks>
        public ServiceProviderFactory(Microsoft.Extensions.DependencyInjection.IServiceProviderFactory<TContainerBuilder> internalFactory,
